...
grant select, insert, update, delete on public.processing_runs to authenticated;
grant all on public.processing_runs to service_role;
grant select, insert, update, delete on public.mark_records to authenticated;
grant all on public.mark_records to service_role;
